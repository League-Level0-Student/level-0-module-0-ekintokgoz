...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		playerLost();
				...
				// 		dragon have left.
		JOptionPane.showMessageDialog(null, "player health:"+playerHealth+ " dragons health:"+dragonHealth);
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "CONGRATS!! YOU DEFEATED THE DRAGON AND WIN A TON OF GOLD!");
		System.exit(0);   //This code ends the program
	}
